...
- Six user-supplied images are integrated into the website:
  - `residence-night.jpeg`
  - `residence-twilight.jpeg`
  - `scene-keypad-six.jpeg`
  - `scene-keypad-three.jpeg`
  - `smart-lock.jpeg`
  - `integration-rack.jpeg`
...
- Written confirmation that Synchro Spaces may publish all six supplied images, including any required property-owner, photographer, installer, or third-party permissions.
...
- Evidence and approved wording for any Control4 dealer status, technology partnership, supported-brand, certification, licence, insurance, award, experience, or performance claim.
- Verified facts for every public case study: permissible location precision, scope, systems, challenges, approach, and outcomes.
- Written permission for every testimonial and its exact attribution.
- Genuine local experience before publishing or indexing any service-area page.
