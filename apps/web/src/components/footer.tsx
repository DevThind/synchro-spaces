      ...
      <div className="container footer-main">
        <div className="footer-brand stack">
          ...
          {hasAddress || hasVerifiedPhone || hasVerifiedEmail ? <address className="footer-contact">
            ...
            {hasVerifiedEmail ? <a href={`mailto:${siteConfig.email}`} aria-label={`Email ${siteConfig.companyName} at ${siteConfig.email}`} data-analytics-event="email_click"><span className="footer-contact__label">Email</span><span>{siteConfig.email}</span></a> : null}
          </address> : null}
