...
export function LeadForm() {
  ...
  return <form className="lead-form" noValidate inert={!hydrated} aria-busy={!hydrated || isSubmitting} data-hydrated={hydrated} onSubmit={handleSubmit(submit)} onFocus={startTracking}>
    <div className="form-section-heading"><span aria-hidden="true">01</span><h2>Your details</h2></div>
    ...
    <div className="form-section-heading"><span aria-hidden="true">02</span><h2>Your project</h2></div>
    ...
    <div className="form-section-heading"><span aria-hidden="true">03</span><h2>Preferences and message</h2></div>
    ...
    <div className="form-group form-group--full"><button className="button button--dark" type="submit" disabled={!hydrated || isSubmitting}>{isSubmitting ? "Sending securely…" : "Send consultation request"}</button>{isSubmitting ? <span className="sr-only" role="status" aria-live="polite">Sending your consultation request.</span> : null}</div>
  </form>;
}
